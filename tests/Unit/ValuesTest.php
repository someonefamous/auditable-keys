...
namespace SomeoneFamous\AuditableKeys\Tests\Unit;

use Carbon\Carbon;
use Illuminate\Foundation\Testing\RefreshDatabase;
use SomeoneFamous\AuditableKeys\Models\AuditableKey;
use SomeoneFamous\AuditableKeys\Tests\TestCase;
...
class ValuesTest extends TestCase
{
    ...
    {
        $testObject = AuditableKey::factory()->create();
